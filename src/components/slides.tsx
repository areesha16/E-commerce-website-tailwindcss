...
const Slide:React.FC<propsType> = ({img, title, mainTitle, price}) => {
  return <div className="outline.none border.none relative">
    ...
    <h2 className="text-blackish text-[260px] md:text-[30px] lg:text-[44px] font-bold leading-[1.2]">
    ...
    <div className="bg-accent text-white text-[14px] md:text-[16px] px-4 rounded-lg inline-block cursor-pointer
    hover:bg-blackish">  
    Shop Now 
    </div>
    </div>
